...
public class PlayerFactory {
    ...
    public Player createPlayerWithName(){
        System.out.println("[root@GameWorld]:# 请为您的角色起一个名字...");
        System.out.print("命令：");
        Scanner s = new Scanner(System.in);
        String name = s.next();
        if(name.equals("") || name==null){
            System.out.println("[root@GameWorld]:# 输入错误，请重新输入");
    ...
    public Player createPlayerWithProfession(){
        System.out.println("[root@GameWorld]:# 请选择一种职业：【勇士】【法师】");
        Scanner s = new Scanner(System.in);
        ...
        if(profession.equals("勇士")){
            ...
            System.out.println("[root@GameWorld]:# 您选择了默认职业：法师");
            return initPlayerAsAWarrior();
        }
    }
